...
Revision ID: 3dc01b60beeb
Revises: add_event_status_columns
Create Date: 2025-03-17 21:17:32.209862
...
revision = '3dc01b60beeb'
down_revision = 'add_event_status_columns'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.Column('date_start', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.Column('date_end', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
